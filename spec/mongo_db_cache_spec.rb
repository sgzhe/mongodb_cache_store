...
RSpec.describe ActiveSupport::Cache::MongoDBCacheStore do
  let(:store) { ActiveSupport::Cache::MongoDBCacheStore.new(db_uri: 'mongodb://127.0.0.1:27017/rails_cache_store') }
